...
const double ServerParam::DEFAULT_PITCH_LENGTH = 40.0;
const double ServerParam::DEFAULT_PITCH_WIDTH = 25.0;
const double ServerParam::DEFAULT_PITCH_MARGIN = 1.0;
const double ServerParam::DEFAULT_CENTER_CIRCLE_R = 0.0;
const double ServerParam::DEFAULT_PENALTY_AREA_LENGTH = 0.0;
const double ServerParam::DEFAULT_PENALTY_AREA_WIDTH = 0.0;
const double ServerParam::DEFAULT_PENALTY_CIRCLE_R = 0.0;
const double ServerParam::DEFAULT_PENALTY_SPOT_DIST = 0.0;
const double ServerParam::DEFAULT_GOAL_AREA_LENGTH = 0.0;
const double ServerParam::DEFAULT_GOAL_AREA_WIDTH = 0.0;
const double ServerParam::DEFAULT_GOAL_DEPTH = 1.0;
const double ServerParam::DEFAULT_CORNER_ARC_R = 0.0;
...
const double ServerParam::DEFAULT_GOAL_WIDTH = 5.0;
