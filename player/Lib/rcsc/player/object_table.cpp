...
{
    ///////////////////////////////////////////////////////////////////////
    const double pitch_half_w   = 34.0;//ServerParam::i().pitchHalfWidth();
    const double pitch_half_l   = 52.5;//ServerParam::i().pitchHalfLength();
    const double penalty_l      = 16.5;//ServerParam::i().penaltyAreaLength();
    const double penalty_half_w = 20.16;//ServerParam::i().penaltyAreaHalfWidth();
    const double goal_half_w    = 7.01;//ServerParam::i().goalHalfWidth();
    ///////////////////////////////////////////////////////////////////////
