...
const double ServerParam::PITCH_LENGTH = 40.0;
const double ServerParam::PITCH_WIDTH = 25.0;
const double ServerParam::PITCH_MARGIN = 1.0;
const double ServerParam::CENTER_CIRCLE_R = 0.0;
const double ServerParam::PENALTY_AREA_LENGTH = 0.0;
const double ServerParam::PENALTY_AREA_WIDTH = 0.0;
const double ServerParam::GOAL_AREA_LENGTH = 0.0;
const double ServerParam::GOAL_AREA_WIDTH = 0.0;
const double ServerParam::GOAL_WIDTH = 5.0;
const double ServerParam::GOAL_DEPTH = 1.0;
const double ServerParam::PENALTY_SPOT_DIST = 0.0;
const double ServerParam::CORNER_ARC_R = 0.0;
