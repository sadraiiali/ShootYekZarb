...
const double Options::PITCH_LENGTH = 40.0;
const double Options::PITCH_WIDTH = 25.0;
...
const double Options::PITCH_MARGIN = 1.0;
const double Options::CENTER_CIRCLE_R = 0.0;
const double Options::PENALTY_AREA_LENGTH = 0.0;
const double Options::PENALTY_AREA_WIDTH = 0.0;
const double Options::PENALTY_CIRCLE_R = 0.0;
const double Options::PENALTY_SPOT_DIST = 0.0;
const double Options::GOAL_WIDTH = 5.0;
const double Options::GOAL_HALF_WIDTH = Options::GOAL_WIDTH * 0.5;
const double Options::GOAL_AREA_LENGTH = 0.0;
const double Options::GOAL_AREA_WIDTH = 0.0;
const double Options::GOAL_DEPTH = 1.0;
const double Options::CORNER_ARC_R = 0.0;
